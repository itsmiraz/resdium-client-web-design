    ...
    return (
        <section  className='mt-20 md:mb-52 mb-20 md:mt-40 px-6'>
            <motion.div
                ...
                className='max-w-[1000px] flex md:flex-row flex-col justify-center md:justify-between items-center bg-[#30585a] p-10 md:p-16 mx-auto md:rounded-ss-[60px] rounded-ss-[30px] md:rounded-ee-[60px] rounded-ee-[30px] gap-6 lg:gap-10' >
