...
const ServiceProcces = () => {
    return (
        <div className='px-6 lg:px-20 py-32'>
            ...
            <p className='text-center text-xs lg:text-sm leading-[16px] text-[#353535]'>
                <Balancer>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 max-w-[900px] mx-auto gap-10 pt-20 '>
                <div className='space-y-10'>
                    <div className='bg-[#284B63] p-6 lg:p-10 space-y-3 rounded-ss-[40px] rounded-ee-[40px] h-fit'>
                        <h1 className='text-[20px] lg:text-[24px] font-semibold text-white  '>Discovery and Planning</h1>
                        ...
                        <p className='text-xs lg:text-sm text-[#D9D9D9] font-medium'>Duration: 1-2 Days</p>
                    </div>

                    <div className='bg-[#212121] p-6 lg:p-10 space-y-3 rounded-ss-[40px] '>
                        <h1 className='text-[20px] lg:text-[24px] font-semibold text-white  '>Development and Coding</h1>
                        <p className='text-[10px] lg:text-xs text-[#D9D9D9]'>
                        ...
                        <p className='text-xs lg:text-sm text-[#D9D9D9] font-medium'>Duration: 2-3 Weeks <span className='text-[10px]'>(Depends on your Projects)</span></p>
                    </div>

                    <div className='bg-[#D9D9D9] p-6 lg:p-10 space-y-3 rounded-ss-[40px] rounded-ee-[40px]'>
                        <h1 className='text-[20px] lg:text-[24px] font-semibold text-zinc-800  '>Client Collaboration</h1>
                        ...
                        <p className='text-xs lg:text-sm text-[#3d3d3d] font-medium'>Duration: 1 Week</p>
                    </div>

                </div>

                <div className='space-y-10'>
                    <div className='bg-[#3C6E71] lg:mt-32 p-6 lg:p-10 space-y-3 rounded-ss-[40px] rounded-ee-[40px]'>
                        <h1 className='text-[20px] lg:text-[24px] font-semibold text-white  '>Design and Prototype</h1>
                        <p className='text-[10px] lg:text-xs text-[#D9D9D9]'>
                        ...
                        <p className='text-xs lg:text-sm text-[#D9D9D9] font-medium'>Duration: 1-2 Weeks</p>
                    </div>
                    <div className='bg-[#4B4F55] mt-20 p-6 lg:p-10 space-y-3 rounded-ee-[40px]'>
                        <h1 className='text-[20px] lg:text-[24px] font-semibold text-white  '>Testing and Quality</h1>
                        <p className='text-[10px] lg:text-xs text-[#D9D9D9]'>
                        ...
                        <p className='text-xs lg:text-sm text-[#D9D9D9] font-medium'>Duration: 1 Week</p>
                    </div>
                    <div className='bg-[#0B657D] mt-20 p-6 lg:p-10 space-y-3 rounded-ss-[40px] rounded-ee-[40px]'>
                        <h1 className='text-[20px] lg:text-[24px] font-semibold text-white  '>Launch and Deployment</h1>
                        <p className='text-[10px] lg:text-xs text-[#D9D9D9]'>
