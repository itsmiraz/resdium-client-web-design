...
const ServicePageHero = () => {
    ...
    return (
        <section ref={sectionRef} className='inner-shadow bg-gradient-to-l from-[#22323F] to-[#3C6E71] flex lg:rounded-ss-[30px] lg:rounded-ee-[30px] items-center justify-center bg-cover bg-no-repeat bg-center h-screen lg:h-full ' >
            <motion.div
                initial='initial'
                ...
                <h1 className='text-[26px] lg:text-[42px] leading-[28px] lg:leading-[46px] font-bold text-white'>
                    Comprehensive Web <br className='lg:block hidden' />
                    Development Services
                </h1>
                <p className='text-[10px] lg:text-lg text-gray-200'>
                    <Balancer>
