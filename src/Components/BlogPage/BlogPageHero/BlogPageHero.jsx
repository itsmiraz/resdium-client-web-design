    ...
    return (
        <div className='px-6 lg:px-20 py-10 lg:py-32'>
            <div className='grid grid-cols-1  lg:grid-cols-2 place-items-center gap-10'>
                <div>
                    <h1 className='text-[32px] leading-[36px] lg:text-[64px] font-bold lg:leading-[72px]  text-gray-700'>
                        {
                            BlogHeroConstants.title
                        }
                        <p className='text-[#666] text-[14px] leading-[16px]  lg:text-[18px] lg:leading-[20px] mt-3 lg:mt-6 font-medium'>
